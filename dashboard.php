...
<!-- Estructura del Nav -->
            ...
            <center><object id="front-page-logo"  data="assets/img/hologa.png">Tu Navegador No Soporta SVG</object></a></li></center>
              ...
              <li class="bold"><a href="blaster.php" class="waves-effect waves-teal"><i class="material-icons">send</i>Blaster<span class="new badge deep-blue" data-badge-caption="Ready"></span></span></a></li>
            </ul>
      ...
      <main><div class="section no-pad-bot" id="index-banner">
              <div class="container">
                ...
                <div class='row center'>
                  ...
                  <div class="row center"><a class="red-text text-lighten-4">beta release v0.4</a></div>
                </div><br>
    ...
    <!--    </div>
              ...
              <div class="section">
                <div class="row center">
                  ...
                  <p class="col s12 m8 offset-m2 caption">Insertar texto</p>
                  <a href="#" class="btn-large waves-effect waves-light">Explorar</a>
                </div>
              </div>  -->
