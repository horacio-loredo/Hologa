     ...
     <nav>
       <div class="nav-wrapper white">
         ...
         <ul class="right hide-on-med-and-down">
          <li class="bold"><a href="dashboard.php"><i class="material-icons left grey-text">dashboard</i>Dashboard</a></li>
           ...
           <li><a href="#"><i class="material-icons left grey-text">speaker_notes</i>Dialer SIP</a><span class="new badge" data-badge-caption="Proximamente"></span></li>
           <li><a href="#"><i class="material-icons left grey-text">send</i>Blaster</a><span class="new badge" data-badge-caption="Proximamente"></span></li>
         </ul>
         <ul class="side-nav" id="mobile-demo">
          ...
          <li><a href="dashboard.php"><i class="material-icons left">dashboard</i>Dashboard</a></li>
           ...
           <li><a href="#"><i class="material-icons left">send</i>Blaster</a></li>
         </ul>
       </div>
     </nav>
      ...
      <div id="demo-ribbon">
         <div class="container">
             <div class="row">
                 <div class="titulo">
                     <h3 class="black-text">Mensajes Enviados Blaster</h3>
